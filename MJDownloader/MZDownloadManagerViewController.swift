...
class MZDownloadManagerViewController: UITableViewController {
    ...
    let cellIdentifier  = "MZDownloadingCell"
...
extension MZDownloadManagerViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = self.tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! MZDownloadingCell
...
extension MZDownloadManagerViewController: MZDownloadManagerDelegate {
    ...
    func downloadRequestFinished(_ downloadModel: MZDownloadModel, index: Int) {
        ...
        let docDirectoryPath : String = downloadModel.fileName
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: MZUtility.DownloadCompletedNotif), object: docDirectoryPath)
    }
