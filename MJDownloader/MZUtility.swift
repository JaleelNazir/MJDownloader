...
open class MZUtility: NSObject {
    ...
    open static let DownloadCompletedNotif : String =  "com.MZDownloadManager.DownloadCompletedNotif"
    
    open static let baseFilePath : String = NSHomeDirectory().appending("/Documents")
